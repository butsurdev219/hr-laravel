...
jQuery(function($){
    ...
    dataTableRecruit = $("#dataTable-recruit").DataTable({
        ajax: {
            url: g_baseURL + "/company/recruit/datatable",
            type: 'post',
        ...
        columnDefs: [
            {
                ...
                "render": function ( data, type, row, meta ) {
                    return '<div class="padding-box"><a href="#/jobseeker/recruit/' + row.job_seeker_id + '"><p>' + row.last_name + ' ' + row.first_name + '</p><span>' + row.birthday + '歳／' + row.sex + '</span></a></div>';
                }
            },
            {
                "targets": 1,
                "render": function ( data, type, row, meta ) {
                    return '<div class="padding-box fixed-w200"><a href="#/company/J/' + row.recruit_company_id + '">' + row.recruit_company_name + '</a></div>';
                }
            },
            {
                "targets": 2,
                "render": function ( data, type, row, meta ) {
                    return '<div class="padding-box fixed-w200" data-id="' + row.id +'">'
                        + '<a href="' + g_baseURL + '/company/job_show/J/' + row.recruit_offer_info_id + '">' + row.job_title + '</a><br>'

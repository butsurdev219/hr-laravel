...
{
    protected $table = 'recruit_offer_infos';
    ...
    public function recruitJobSeekerApplyMgts() {
        return $this->hasMany(RecruitJobSeekerApplyMgts::class, 'recruit_offer_info_id', 'id');
    }
    ...
    public function getSelectionCountAttribute() {
        return $this->hasMany(RecruitJobSeekerApplyMgts::class, 'recruit_offer_info_id', 'id')->count();
    }

<template>
    <div class="card mb-2">
        <div class="card-title">
            ...
            <span class="title">業務委託案件タイムライン</span>
        </div>
        ...
        <div class="card-body card-body--chat">
            <div v-for="msg in message" :key="msg"
                :class="['chat',
                    ...
                    { 'chat--left' : msg.message_type!=1 && msg.sender_type != 3 },
                    { 'chat--right' : msg.message_type!=1 && msg.sender_type == 3 },
                ]">
    ...
    export default {
        ...
        methods: {
            saveTimelineRecord() {
                ...
                let postParam = {
                    jobSeekerApplyMgtID : g_outsourceApplyMgt.id,
        ...
        mounted() {
            let postParam = {id : g_outsourceApplyMgt.id};

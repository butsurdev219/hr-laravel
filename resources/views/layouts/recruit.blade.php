    ...
    <div class="sidebar">
        <div class="sidebar-inner">
            <div class="sidebar-logo">
                <div class="peers ai-c fxw-nw">
                    <div class="peer peer-greed">
                        <a class="sidebar-link td-n" href="{{ route('recruit.home') }}">
            ...
            <ul class="sidebar-menu scrollable pos-r ps">
                <li class="nav-item mT-30 active"><a class="sidebar-link" href="{{ route('recruit.home') }}"><span class="icon-holder"><i class="c-blue-500 ti-home"></i> </span><span class="title">inCulエージェントTOP</span></a></li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="sidebar-link" href="{{ route('recruit.job_list') }}">求人企業一覧</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="dropdown-toggle" href="javascript:void(0);">
                        <span class="icon-holder"><i class="c-teal-500 ti-view-list-alt"></i> </span>
                        <span class="title">人材紹介会社（自社）</span> <span class="arrow"><i class="ti-angle-right"></i></span>
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="sidebar-link" href="{{ route('recruit.jobseeker') }}">転職者一覧</a></li>
                        <li><a class="sidebar-link" href="{{ route('recruit.job_add', ['type' => 'G']) }}">新規転職者登録</a></li>
                    </ul>
                </li>
                <li class="nav-item"><a class="sidebar-link" href="{{ route('recruit.apply.index') }}"><span class="icon-holder"><i class="c-blue-500 ti-share"></i> </span><span class="title">人材紹介ー選考</span></a></li>
                <li class="nav-item">
                    <a class="sidebar-link" href="{{ route('recruit.calendar') }}">
                ...
                <li class="nav-item">
                    <a class="sidebar-link" href="{{ route('recruit.qa_list') }}">
                        <div class="float-right">
    ...
    <div class="page-container">
        <div class="header navbar">
            <div class="header-container">
                ...
                <ul class="nav-right">
                    <li>
                        <a href="{{ route('recruit.home') }}"><u>▶アライアンス求人管理へ切替</u></a>
                    </li>
                    ...
                    <li class="dropdown">
                        <a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                            <!-- <div class="peer mR-10"><img class="w-2r bdrs-50p" src="{{ $user->recruit_user->company->logo_url }}" alt=""></div> -->
                            <!-- <div class="peer mR-10"><img class="w-3r bdrs-40p" src="/assets/static/images/404.png" alt=""></div> -->
                            <div class="peer mR-10"><img class="w-3r bdrs-40p" src="{{ $user->recruit_user->company->full_logo }}" alt=""></div>
                            <div class="peer"><span class="fsz-sm c-grey-900">{{ $user->recruit_user->company->name }}／{{ $user->recruit_user->name }}</span></div>

...
@section('title', 'inCulエージェント 業務委託・SES参画者の選考状況詳細')
        ...
        <div class="col-md-6">
            <div class="card mb-2">
                <div class="card-body ta-c">
                    <a href="#" class="seeker_name black">{{ $jobSeeker->initial }}</a> ／ <a href="{{ route('outsource.job_show', ['type' => 'G', 'id' => $offerInfo->id]) }}" class="black">{{ $offerInfo->job_title }}</a>
                </div>
            </div>
            ...
            <div class="card mb-2 card__tabs">
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <div class="shortcut"><a href="/ses/job_show/G/{{ $offerInfo->id }}" class="c-grey-icon">求人情報 ></a></div>
                      </ul>
...
<script>
    ...
    let enumOutsourceRefusalReasons = @json(g_enum('outsource_refusal_reason'));
...
<script src="{{ url('js/outsource/apply_detail.js') }}"></script>

...
@section('title', 'inCulエージェント 求職者の面接・面談予定カレンダー（人材紹介）')
            ...
            <div class="card mb-2">
                <div class="card-body ta-c pX-0">
                    ...
                    <p id="interview_list" class="text">
                        ...
                        <a style="color: blue;" href="/agent/apply/{{ $schedule->job_seeker_apply_mgt_id }}">{{ $schedule->interview_candidates_name }}さん</a>
        ...
        calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function(arg) {
                if (confirm(arg.event.title+'の選考詳細ページへ移行しますか?')) {
                    window.location.href = "/agent/apply/" + arg.event.groupId;
                }
            },
            editable: false,

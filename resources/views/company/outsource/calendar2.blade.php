        ...
        <div class="col-md-3" style="padding: 0px;">
            ...
            <div class="card mb-2">
                <div class="card-body ta-c">
                    ...
                    <b>{{ $jobSeeker->initial }}さんへ希望日程を提示する</b><br/><br/>
                    選考の日程を右の予定表より選択して送信してください。<br/>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            select: function(arg) {
                var title = '{{ $jobSeeker->initial }}'; // prompt('Event Title:');
                if (title) {
                    calendar.addEvent({
                        title: title,
                        start: arg.start,
...
<?php } ?>
        ...
        $("#btn_sendSchedule").click(function() {
            if (schedules.length == 0) {
                alert("候補者へ提示する日程を右の予定表より選択してください。");
                return;
            }

            $.ajax({
                url: "{{ route('company.outsource.send_interview_date') }}",
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}', 
